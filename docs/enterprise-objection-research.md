...
- The SFS wiki emphasizes low-pressure replies, correct classification, small next steps, `1 / 2 / 3` options, and clean exits on hard no or suppression requests.
  Local sources:
  - `/Users/jameswrest/blueswans-openclaw-monitoring-pr/wiki/solar-future-scotland-reply-learnings-playbook.md`
  - `/Users/jameswrest/blueswans-openclaw-monitoring-pr/docs/sops/sfs-positive-reply-desktop-assumption-sop.md`
